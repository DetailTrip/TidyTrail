...
const HeroSection: React.FC = () => {
  return (
    <section className="relative bg-[url('/og/og-home.png')] bg-cover bg-left min-h-[680px] flex items-center bg-blend-darken bg-black/40"
      role="img"
...
<p className="text-sm text-white/80 pt-1">
  Starting at <span className="font-semibold text-tidy-gold">$24/visit</span> — no hidden fees
          ...
          {/* Audience Message (hidden on very small screens) */}
