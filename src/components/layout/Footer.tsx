    ...
    <footer className="bg-gray-800 text-white pt-12 pb-6">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-display font-bold mb-4">TidyTrails</h3>
            <p className="text-gray-300 mb-4">
              Professional yard maintenance services for residential and commercial properties in Timmins, Ontario.
            </p>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              <p className="mb-2">85 Pinewood Drive</p>
              <p className="mb-2">Timmins, Ontario P4N 6N3</p>
              <p className="mb-2">
                <a href="tel:+17058574321" className="hover:text-accent">
                  (705) 857-4321
                </a>
              </p>
              <p className="mb-2">
                <a href="mailto:info@tidytrails.ca" className="hover:text-accent">
                  info@tidytrails.ca
                </a>
              </p>
            </address>
        ...
        <div className="pt-6 border-t border-gray-700 text-gray-400 text-sm">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>© {currentYear} TidyTrails Yard Services. All rights reserved.</p>
            <div className="flex space-x-4 mt-4 md:mt-0">
              <Link to="/about" className="hover:text-accent">Privacy Policy</Link>
              <Link to="/about" className="hover:text-accent">Terms of Service</Link>
            </div>
          </div>
        </div>
      </div>
